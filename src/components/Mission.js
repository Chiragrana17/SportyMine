    ...
    <section className="what-we-do" id="mission">
      ...
      <div className="features">
        <div className="feature-card">
          <img src="/p2a.jpg" alt="Our Vision" className="feature-img" />
          <h3> Our Vision </h3>{" "}
          <p>
            At SportyMine, we focus on a future where every child discovers the
        ...
        <div className="feature-card">
          <img src="/p2b.jpg" alt="Our Mission" className="feature-img" />
          <h3> Our Products </h3>{" "}
          <p>
